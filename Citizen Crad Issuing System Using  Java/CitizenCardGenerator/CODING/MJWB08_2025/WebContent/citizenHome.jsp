...
<a href="login.html" class="w3-button w3-teal">logout</a><a href="changePassword.jsp" class="w3-button w3-teal">Change password</a>
<%
try{  
	...
	<h1 class="w3-teal w3-cen ter">CITIZEN CARD</h1>
	<h2>CARD NO:<%=card %></h2>
	...
	while(rs.next())
	{
		...
		<tr><td>GENDER</td><td><%=rs.getString(2) %></td></tr>
		...
		<tr><td>Date of Issuing</td><td><%=rs.getDate(17) %></td></tr>
		<%
	}
	%></table>
	</div>
